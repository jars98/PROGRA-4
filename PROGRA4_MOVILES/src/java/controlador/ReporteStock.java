...
public class ReporteStock implements Serializable {
    ...
    public void generarReporte() {
        ...
        String reportPath = sc.getRealPath("vista/reportes/StockProductos.jasper");
...
//        parametros.put("logo", logoPath);
        ...
        httpServletResponse.setHeader("Content-Disposition", "inline; filename=Stock_Productos.pdf");
